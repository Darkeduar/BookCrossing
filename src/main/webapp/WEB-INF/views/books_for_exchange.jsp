            ...
            <div class="col-sm-6">
                <c:forEach items="${books}" var="book">
                    ...
                    <div class="card" style="width: 18rem;">
                        <img class="card-img-top" src="/resources/images/${book.image.name}" alt="Card image cap">
                        <div class="card-body">
                            <h5 class="card-title">${book.title}</h5>
                            <p class="card-text">${book.description}</p>
                            <a href="/messages/create/${book.user.id}" class="btn btn-primary">Contact owner»</a>
                        </div>
                    </div>
